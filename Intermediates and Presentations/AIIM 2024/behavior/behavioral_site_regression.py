...
def main() :
    ...
    np.save('/data/NIMH_scratch/zwallymi/behavioral/site_regressed_scores.npy', combat['data'])
    ...
    ax.axhline(y=0.05, color='dimgrey', linestyle='--')
    ...
    vars_to_keep = PCs[:, :6] #keep components that account for first 95% of variance
    np.save('/data/NIMH_scratch/zwallymi/behavioral/new_regressed_behavioral_pca.npy', vars_to_keep)
