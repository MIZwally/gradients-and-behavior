...
def main() :
    ...
    files = os.listdir('/data/NIMH_scratch/zwallymi/gradients/individual_files/parcellated/site_regressed_matrices')
    ...
    for i, mat in enumerate(matrices) :
        ...
        np.save(f'/data/NIMH_scratch/zwallymi/gradients/individual_files/parcellated/spearman_site_regressed_gradients/{sub}_gradients.npy', gradient.aligned_)
    ...
    np.save('/data/NIMH_scratch/zwallymi/gradients/new_regressed_spearman_correlations.npy', correlations)
