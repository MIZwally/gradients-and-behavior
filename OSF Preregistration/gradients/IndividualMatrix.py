...
def gifti_conversion(sub, lscratch) :
    ...
    #targetL = sub+'_ses-baselineYear1Arm1_hemi-L_midthickness.surf.gii'
    #targetR = sub+'_ses-baselineYear1Arm1_hemi-R_midthickness.surf.gii'
...
def clean_smooth_and_project(directory, subject, lscratch, run) :
    ...
    smooth_img = smooth(subject, lscratch, run)
...
def create_individual_fc_matrix(clean_ts, vertices=False) :
    ...
    #maps labels to vertices in time series
