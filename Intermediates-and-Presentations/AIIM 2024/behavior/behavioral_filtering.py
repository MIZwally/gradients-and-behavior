...
#This code formats tabulated data and removes bad subjects
...
def main() :
    ...
    prosocial_na = None #remove specific subject IDs here
    ...
    scores_cleaned.to_csv('/data/NIMH_scratch/zwallymi/behavioral/regressed_scores.csv')
